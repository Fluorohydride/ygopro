...
function c43241495.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(43241495,0))
	e3:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e3:SetType(EFFECT_TYPE_TRIGGER_O+EFFECT_TYPE_SINGLE)
	e3:SetCategory(CATEGORY_TOHAND)
	e3:SetCode(EVENT_SUMMON_SUCCESS)
	e3:SetTarget(c43241495.thtg)
	e3:SetOperation(c43241495.thop)
	c:RegisterEffect(e3)
end
...
function c43241495.thcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return (seq==6 or seq==7) and eg:IsExists(c43241495.cfilter,1,nil,tp)
end
...
function c43241495.thop(e,tp,eg,ep,ev,re,r,rp)
