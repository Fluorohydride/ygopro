...
function c85138716.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if dg:GetCount()>=1 then
		...
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
		local sg2=dg:FilterSelect(tp,Card.IsCode,1,1,nil,sg:GetFirst():GetCode())
		Duel.SpecialSummonStep(sg:GetFirst(),0,tp,tp,false,false,POS_FACEUP)
		Duel.SpecialSummonStep(sg2:GetFirst(),0,tp,tp,false,false,POS_FACEUP)
		sg:GetFirst():RegisterFlagEffect(85138716,RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_END,0,1)
		sg2:GetFirst():RegisterFlagEffect(85138716,RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_END,0,1)
