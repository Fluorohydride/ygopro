...
function c20057949.initial_effect(c)
	...
	if not c20057949.global_check then
		...
		ge1:SetOperation(c20057949.checkop)
...
function c20057949.checkop(e,tp,eg,ep,ev,re,r,rp)
...
function c20057949.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.GetMatchingGroup(c20057949.filter,tp,LOCATION_HAND,0,nil,e,tp)
	if g:GetCount()==0 then return end
	if Duel.SelectYesNo(tp,aux.Stringid(20057949,0)) then
