...
function c61307542.cfilter(c)
	return c:IsType(TYPE_TRAP) and c:IsPreviousLocation(LOCATION_SZONE) and c:GetPreviousSequence()<5
end
function c61307542.condition(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c61307542.cfilter,1,nil)
end
