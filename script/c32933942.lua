...
function c32933942.initial_effect(c)
	...
	e1:SetTarget(c32933942.reptarget)
	e1:SetOperation(c32933942.repoperation)
	c:RegisterEffect(e1)
	--direct attack
...
function c32933942.reptarget(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c32933942.repoperation(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
