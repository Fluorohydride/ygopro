...
function c69890967.tkop(e,tp,eg,ep,ev,re,r,rp)
	...
	if ft==0 or not Duel.IsPlayerCanSpecialSummonMonster(tp,69890968,0,1000,1000,1,RACE_FIEND,ATTRIBUTE_DARK) then return end
	local token=Duel.CreateToken(tp,69890968,0,1000,1000,1,RACE_FIEND,ATTRIBUTE_DARK)
