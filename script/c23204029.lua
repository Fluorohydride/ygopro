...
function c23204029.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsOnField() and c23204029.filter(chkc) end
	if chk==0 then return Duel.IsExistingTarget(c23204029.filter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_FACEUP)
	local g=Duel.SelectTarget(tp,c23204029.filter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,1,1,nil)
