...
function c6330307.atkop(e,tp,eg,ep,ev,re,r,rp)
	...
	if at:IsRelateToBattle() and not at:IsImmuneToEffect(e) and at:GetAttack()>0 then
		...
		e4:SetValue(c6330307.exttg)
		e4:SetReset(RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_DAMAGE_CAL)
		...
		e5:SetOperation(c6330307.atrst)
...
function c6330307.atrst(e,tp,eg,ep,ev,re,r,rp)
	local e2=e:GetLabelObject()
	local e3=e2:GetLabelObject()
	local e4=e3:GetLabelObject()
	if eg:GetFirst()~=e2:GetHandler() then
		e2:Reset()
		e3:Reset()
		e4:Reset()
	end
