...
function c37991342.initial_effect(c)
	...
	e2:SetCondition(c37991342.pendcon)
	...
	e3:SetCondition(c37991342.pendcon)
	e3:SetValue(-300)
	c:RegisterEffect(e3)
	...
	e5:SetCondition(c37991342.lvcon)
	e5:SetOperation(c37991342.lvop)
	c:RegisterEffect(e5)
	local e6=Effect.CreateEffect(c)
	e6:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_CONTINUOUS)
	e6:SetCode(EVENT_SPSUMMON_SUCCESS)
	e6:SetOperation(c37991342.lvop)
	c:RegisterEffect(e6)
	--immune
