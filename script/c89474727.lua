...
function c89474727.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c89474727.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return not e:GetHandler():IsHasEffect(EFFECT_IMMUNE_EFFECT) end
end
...
function c89474727.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chkc then return chkc:IsLocation(LOCATION_REMOVED) and c89474727.filter(chkc,e,tp) end
