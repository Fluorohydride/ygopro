...
function c15521027.tga(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetFieldGroupCount(tp,LOCATION_DECK,0)>0
		and Duel.IsExistingMatchingCard(c15521027.cfilter,tp,LOCATION_DECK,0,1,nil) end
...
function c15521027.opa(e,tp,eg,ep,ev,re,r,rp)
	...
	local sg=g:FilterSelect(tp,c15521027.filter,1,1,nil)
