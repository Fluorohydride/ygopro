...
function c80200018.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(80200018,1))
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_MZONE)
	e2:SetCountLimit(1,80200018)
	e2:SetCost(c80200018.cost)
	e2:SetTarget(c80200018.target)
	e2:SetOperation(c80200018.operation)
	c:RegisterEffect(e2)
end
