...
function c269012.thcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return g:IsPreviousLocation(LOCATION_ONFIELD) and g:IsReason(REASON_EFFECT)
end
function c269012.thfilter(c,e)
	return c:IsAttribute(ATTRIBUTE_DEVINE)
end
function c269012.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c269012.thfilter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c269012.thop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectMatchingCard(tp,c269012.thfilter,tp,LOCATION_DECK,0,1,1,nil)
