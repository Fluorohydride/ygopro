		...
		case irr::EMIE_LMOUSE_LEFT_UP: {
			...
			if(!mainGame->is_siding) {
				...
				if((hovered_pos == 1 || (hovered_pos == 0 && click_pos == 1)) && deckManager.current_deck.main.size() < 60) {
					if(hovered_seq < (int)deckManager.current_deck.main.size() && hovered_pos)
					...
					if(hovered_seq < (int)deckManager.current_deck.extra.size() && hovered_pos)
					...
					if(hovered_seq < (int)deckManager.current_deck.side.size() && hovered_pos)
