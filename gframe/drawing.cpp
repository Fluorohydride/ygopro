...
#undef SKCOLOR
	...
	textFont->draw(dInfo.selfnames[dInfo.current_player[LocalPlayer(0)]].c_str(), p1size, 0xffffffff, false, false, 0);
	auto cld = textFont->getDimension(dInfo.opponames[dInfo.current_player[LocalPlayer(1)]]);
	p2size.UpperLeftCorner.X -= cld.Width;
	textFont->draw(dInfo.opponames[dInfo.current_player[LocalPlayer(1)]].c_str(), p2size, 0xffffffff, false, false, 0);
