...
public:
	...
	S3DVertex vField[4];
	S3DVertex vFieldSpell[2][4];
	S3DVertex vFieldSpell1[2][4];
	S3DVertex vFieldSpell2[2][4];
	//S3DVertex vBackLine[76];
	S3DVertex vFieldDeck[2][2][4];
	S3DVertex vFieldGrave[2][2][2][4];
	S3DVertex vFieldExtra[2][2][4];
	S3DVertex vFieldRemove[2][2][2][4];
	S3DVertex vFieldMzone[2][7][4];
	S3DVertex vFieldSzone[2][8][2][2][4];
