...
public:
	...
	static void SinglePlayRefreshGrave(int player, int flag = 0x781fff);
	static void SinglePlayRefreshDeck(int player, int flag = 0x781fff);
	static void SinglePlayRefreshExtra(int player, int flag = 0x781fff);
