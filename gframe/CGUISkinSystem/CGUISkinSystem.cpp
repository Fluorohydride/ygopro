...
bool CGUISkinSystem::loadCustomColors(gui::CImageGUISkin * skin) {
	static const std::map<std::wstring, ygo::skin::CustomSkinElements> alias = {
		{ L"CARDINFO_ARCHETYPE_TEXT_COLOR", ygo::skin::CustomSkinElements::CARDINFO_ARCHETYPE_TEXT_COLOR },
		{ L"CARDINFO_IMAGE_BACKGROUND", ygo::skin::CustomSkinElements::CARDINFO_IMAGE_BACKGROUND },
		{ L"CARDINFO_STATS_COLOR", ygo::skin::CustomSkinElements::CARDINFO_STATS_COLOR },
		{ L"CARDINFO_TYPES_COLOR", ygo::skin::CustomSkinElements::CARDINFO_TYPES_COLOR },
		{ L"DECK_WINDOW_EXTRA_BOTTOM_LEFT", ygo::skin::CustomSkinElements::DECK_WINDOW_EXTRA_BOTTOM_LEFT },
		{ L"DECK_WINDOW_EXTRA_BOTTOM_RIGHT", ygo::skin::CustomSkinElements::DECK_WINDOW_EXTRA_BOTTOM_RIGHT },
		{ L"DECK_WINDOW_EXTRA_INFO_BOTTOM_LEFT", ygo::skin::CustomSkinElements::DECK_WINDOW_EXTRA_INFO_BOTTOM_LEFT },
		{ L"DECK_WINDOW_EXTRA_INFO_BOTTOM_RIGHT", ygo::skin::CustomSkinElements::DECK_WINDOW_EXTRA_INFO_BOTTOM_RIGHT },
		{ L"DECK_WINDOW_EXTRA_INFO_TOP_LEFT", ygo::skin::CustomSkinElements::DECK_WINDOW_EXTRA_INFO_TOP_LEFT },
		{ L"DECK_WINDOW_EXTRA_INFO_TOP_RIGHT", ygo::skin::CustomSkinElements::DECK_WINDOW_EXTRA_INFO_TOP_RIGHT },
		{ L"DECK_WINDOW_EXTRA_TOP_LEFT", ygo::skin::CustomSkinElements::DECK_WINDOW_EXTRA_TOP_LEFT },
		{ L"DECK_WINDOW_EXTRA_TOP_RIGHT", ygo::skin::CustomSkinElements::DECK_WINDOW_EXTRA_TOP_RIGHT },
		{ L"DECK_WINDOW_HOVERED_CARD_RESULT", ygo::skin::CustomSkinElements::DECK_WINDOW_HOVERED_CARD_RESULT },
		{ L"DECK_WINDOW_MAIN_BOTTOM_LEFT", ygo::skin::CustomSkinElements::DECK_WINDOW_MAIN_BOTTOM_LEFT },
		{ L"DECK_WINDOW_MAIN_BOTTOM_RIGHT", ygo::skin::CustomSkinElements::DECK_WINDOW_MAIN_BOTTOM_RIGHT },
		{ L"DECK_WINDOW_MAIN_INFO_BOTTOM_LEFT", ygo::skin::CustomSkinElements::DECK_WINDOW_MAIN_INFO_BOTTOM_LEFT },
		{ L"DECK_WINDOW_MAIN_INFO_BOTTOM_RIGHT", ygo::skin::CustomSkinElements::DECK_WINDOW_MAIN_INFO_BOTTOM_RIGHT },
		{ L"DECK_WINDOW_MAIN_INFO_TOP_LEFT", ygo::skin::CustomSkinElements::DECK_WINDOW_MAIN_INFO_TOP_LEFT },
		{ L"DECK_WINDOW_MAIN_INFO_TOP_RIGHT", ygo::skin::CustomSkinElements::DECK_WINDOW_MAIN_INFO_TOP_RIGHT },
		{ L"DECK_WINDOW_MAIN_TOP_LEFT", ygo::skin::CustomSkinElements::DECK_WINDOW_MAIN_TOP_LEFT },
		{ L"DECK_WINDOW_MAIN_TOP_RIGHT", ygo::skin::CustomSkinElements::DECK_WINDOW_MAIN_TOP_RIGHT },
		{ L"DECK_WINDOW_SEARCH_RESULT_BOTTOM_LEFT", ygo::skin::CustomSkinElements::DECK_WINDOW_SEARCH_RESULT_BOTTOM_LEFT },
		{ L"DECK_WINDOW_SEARCH_RESULT_BOTTOM_RIGHT", ygo::skin::CustomSkinElements::DECK_WINDOW_SEARCH_RESULT_BOTTOM_RIGHT },
		{ L"DECK_WINDOW_SEARCH_RESULT_INFO_BOTTOM_LEFT", ygo::skin::CustomSkinElements::DECK_WINDOW_SEARCH_RESULT_INFO_BOTTOM_LEFT },
		{ L"DECK_WINDOW_SEARCH_RESULT_INFO_BOTTOM_RIGHT", ygo::skin::CustomSkinElements::DECK_WINDOW_SEARCH_RESULT_INFO_BOTTOM_RIGHT },
		{ L"DECK_WINDOW_SEARCH_RESULT_INFO_TOP_LEFT", ygo::skin::CustomSkinElements::DECK_WINDOW_SEARCH_RESULT_INFO_TOP_LEFT },
		{ L"DECK_WINDOW_SEARCH_RESULT_INFO_TOP_RIGHT", ygo::skin::CustomSkinElements::DECK_WINDOW_SEARCH_RESULT_INFO_TOP_RIGHT },
		{ L"DECK_WINDOW_SEARCH_RESULT_TOP_LEFT", ygo::skin::CustomSkinElements::DECK_WINDOW_SEARCH_RESULT_TOP_LEFT },
		{ L"DECK_WINDOW_SEARCH_RESULT_TOP_RIGHT", ygo::skin::CustomSkinElements::DECK_WINDOW_SEARCH_RESULT_TOP_RIGHT },
		{ L"DECK_WINDOW_SIDE_BOTTOM_LEFT", ygo::skin::CustomSkinElements::DECK_WINDOW_SIDE_BOTTOM_LEFT },
		{ L"DECK_WINDOW_SIDE_BOTTOM_RIGHT", ygo::skin::CustomSkinElements::DECK_WINDOW_SIDE_BOTTOM_RIGHT },
		{ L"DECK_WINDOW_SIDE_INFO_BOTTOM_LEFT", ygo::skin::CustomSkinElements::DECK_WINDOW_SIDE_INFO_BOTTOM_LEFT },
		{ L"DECK_WINDOW_SIDE_INFO_BOTTOM_RIGHT", ygo::skin::CustomSkinElements::DECK_WINDOW_SIDE_INFO_BOTTOM_RIGHT },
		{ L"DECK_WINDOW_SIDE_INFO_TOP_LEFT", ygo::skin::CustomSkinElements::DECK_WINDOW_SIDE_INFO_TOP_LEFT },
		{ L"DECK_WINDOW_SIDE_INFO_TOP_RIGHT", ygo::skin::CustomSkinElements::DECK_WINDOW_SIDE_INFO_TOP_RIGHT },
		{ L"DECK_WINDOW_SIDE_TOP_LEFT", ygo::skin::CustomSkinElements::DECK_WINDOW_SIDE_TOP_LEFT },
		{ L"DECK_WINDOW_SIDE_TOP_RIGHT", ygo::skin::CustomSkinElements::DECK_WINDOW_SIDE_TOP_RIGHT },
		{ L"DUELFIELD_ANNOUNCE_TEXT_BACKGROUND_COLOR", ygo::skin::CustomSkinElements::DUELFIELD_ANNOUNCE_TEXT_BACKGROUND_COLOR },
		{ L"DUELFIELD_ANNOUNCE_TEXT_COLOR", ygo::skin::CustomSkinElements::DUELFIELD_ANNOUNCE_TEXT_COLOR },
		{ L"DUELFIELD_CARD_OPPONENT_WINDOW_BACKGROUND", ygo::skin::CustomSkinElements::DUELFIELD_CARD_OPPONENT_WINDOW_BACKGROUND },
		{ L"DUELFIELD_CARD_SELECTED_WINDOW_BACKGROUND", ygo::skin::CustomSkinElements::DUELFIELD_CARD_SELECTED_WINDOW_BACKGROUND },
		{ L"DUELFIELD_CARD_SELECT_WINDOW_OVERLAY_TEXT", ygo::skin::CustomSkinElements::DUELFIELD_CARD_SELECT_WINDOW_OVERLAY_TEXT },
		{ L"DUELFIELD_CARD_SELECT_WINDOW_SET_TEXT", ygo::skin::CustomSkinElements::DUELFIELD_CARD_SELECT_WINDOW_SET_TEXT },
		{ L"DUELFIELD_CARD_SELF_WINDOW_BACKGROUND", ygo::skin::CustomSkinElements::DUELFIELD_CARD_SELF_WINDOW_BACKGROUND },
		{ L"DUELFIELD_HIGHLIGHTING_CARD_OUTLINE", ygo::skin::CustomSkinElements::DUELFIELD_HIGHLIGHTING_CARD_OUTLINE },
		{ L"DUELFIELD_HOVERED", ygo::skin::CustomSkinElements::DUELFIELD_HOVERED },
		{ L"DUELFIELD_LINKED", ygo::skin::CustomSkinElements::DUELFIELD_LINKED },
		{ L"DUELFIELD_MUTUAL_LINKED", ygo::skin::CustomSkinElements::DUELFIELD_MUTUAL_LINKED },
		{ L"DUELFIELD_SELECTABLE_CARD_OUTLINE", ygo::skin::CustomSkinElements::DUELFIELD_SELECTABLE_CARD_OUTLINE },
		{ L"DUELFIELD_SELECTABLE_FIELD_OUTLINE", ygo::skin::CustomSkinElements::DUELFIELD_SELECTABLE_FIELD_OUTLINE },
		{ L"DUELFIELD_TOOLTIP_TEXT_BACKGROUND_COLOR", ygo::skin::CustomSkinElements::DUELFIELD_TOOLTIP_TEXT_BACKGROUND_COLOR },
		{ L"DUELFIELD_TOOLTIP_TEXT_COLOR", ygo::skin::CustomSkinElements::DUELFIELD_TOOLTIP_TEXT_COLOR },
		{ L"LPBAR_1_BOTTOM_LEFT", ygo::skin::CustomSkinElements::LPBAR_1_BOTTOM_LEFT },
		{ L"LPBAR_1_BOTTOM_RIGHT", ygo::skin::CustomSkinElements::LPBAR_1_BOTTOM_RIGHT },
		{ L"LPBAR_1_TOP_LEFT", ygo::skin::CustomSkinElements::LPBAR_1_TOP_LEFT },
		{ L"LPBAR_1_TOP_RIGHT", ygo::skin::CustomSkinElements::LPBAR_1_TOP_RIGHT },
		{ L"LPBAR_2_BOTTOM_LEFT", ygo::skin::CustomSkinElements::LPBAR_2_BOTTOM_LEFT },
		{ L"LPBAR_2_BOTTOM_RIGHT", ygo::skin::CustomSkinElements::LPBAR_2_BOTTOM_RIGHT },
		{ L"LPBAR_2_TOP_LEFT", ygo::skin::CustomSkinElements::LPBAR_2_TOP_LEFT },
		{ L"LPBAR_2_TOP_RIGHT", ygo::skin::CustomSkinElements::LPBAR_2_TOP_RIGHT },
		{ L"PROGRESSBAR_EMPTY_COLOR", ygo::skin::CustomSkinElements::PROGRESSBAR_EMPTY_COLOR },
		{ L"PROGRESSBAR_FILL_COLOR", ygo::skin::CustomSkinElements::PROGRESSBAR_FILL_COLOR },
		{ L"ROOMLIST_CUSTOM_ROOM", ygo::skin::CustomSkinElements::ROOMLIST_CUSTOM_ROOM },
		{ L"ROOMLIST_NORMAL_ROOM", ygo::skin::CustomSkinElements::ROOMLIST_NORMAL_ROOM },
		{ L"ROOMLIST_STARTED_ROOM", ygo::skin::CustomSkinElements::ROOMLIST_STARTED_ROOM },
		{ L"ROOMLIST_TEXTS_COLOR", ygo::skin::CustomSkinElements::ROOMLIST_TEXTS_COLOR }
	};
